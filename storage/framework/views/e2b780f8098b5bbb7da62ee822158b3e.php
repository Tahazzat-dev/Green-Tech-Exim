...
<?php if(session('pending_account_popup')): ?>
    <div
        x-data="{ open: true }"
        x-show="open"
...
<div class="flex items-center justify-center w-full min-h-screen h-full p-4 mx-auto" >
    <div class="w-full max-w-[500px] shadow-lg bg-background rounded-2xl p-4 md:p-5 lg:py-8 xl:py-10" >
        ...
        <div class="mb-8">
            ...
            <form autocomplete="off"  method="POST" action="<?php echo e(route('signin.submit')); ?>" class="space-y-5">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="space-y-2 text-center">
                    <p>Don't have an account? <a class="ml-1 underline link-text" href="<?php echo e(route('signup')); ?>" >Sign Up</a></p>
                    <a class="inline-block underline link-text" href="<?php echo e(route('home')); ?>">
                        Continue as guest
                    </a>
                    <!-- <p>
                        <a class="underline link-text" href="<?php echo e(route('admin.signin')); ?>">
                            Admin login
                        </a>
                    </p> -->
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/tahazzat/works/projects/personal-projects/trophy-app/trophy-app-web/resources/views/auth/signin.blade.php ENDPATH**/ ?>