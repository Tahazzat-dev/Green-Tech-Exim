...
unset($__errorArgs, $__bag); ?>
    ...
    <form
        action="<?php echo e(route('admin.settings.password.update')); ?>"
        method="POST"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /data/projects/personal-projects/trophy-app/trophy-app-web/resources/views/admin/settings/edit.blade.php ENDPATH**/ ?>