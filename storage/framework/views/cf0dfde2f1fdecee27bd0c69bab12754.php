...
<div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
    ...
    <div class="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
        ...
        <!-- Search Form -->
        <form
            action="<?php echo e(route('admin.users.index')); ?>"
             method="GET"
            ...
            <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <tr class="border-t border-border">
                    ...
                    <td class="p-4">
                        ...
                        <img
                            src="<?php echo e($user->photo ? asset('storage/' . $user->photo) : 'https://placehold.co/60x60'); ?>"
                    ...
                    <td class="p-4 font-semibold">
                        <?php echo e($user->plain_pin ?? 'Reset needed'); ?>

                    </td>

                    <!-- Shop -->
                    <td class="p-4">
                        <?php echo e($user->shop_name); ?>

                    </td>

                    <!-- Discount -->
                    <td class="p-4 pl-9">
                        <?php echo e($user->discount ?? 0); ?>%
                    </td>
                    ...
                    <td class="p-4">
                        ...
                        <span class="
                            ...
                            <?php echo e($user->status === 'approved'
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/tahazzat/works/projects/personal-projects/trophy-app/trophy-app-web/resources/views/admin/users/index.blade.php ENDPATH**/ ?>