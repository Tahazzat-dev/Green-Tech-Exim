            ...
            >
                ...
                <nav class="hidden lg:flex text-base lg:gap-10">
                    <?php if(auth()->guard()->guest()): ?>
                        <a href="<?php echo e(route('categories.all')); ?>" class="nav-link text-base font-medium <?php echo e(request()->routeIs('home', 'categories.all') ? 'active' : ''); ?>">Categories</a>
                    <?php endif; ?>
                  <?php if(auth()->guard()->check()): ?>
                     <?php if(auth()->user()->role === 'user'): ?>
                            <a href="<?php echo e(route('categories.all')); ?>" class="nav-link text-base font-medium <?php echo e(request()->routeIs('categories.all') ? 'active' : ''); ?>">Categories</a>
                            <a href="<?php echo e(route('executives')); ?>" class="nav-link text-base font-medium <?php echo e(request()->routeIs('executives') ? 'active' : ''); ?>">Contact Us</a>
                            <?php if($appSettings->facebook_page_url): ?>
                                <a href="<?php echo e($appSettings->facebook_page_url); ?>" target="_blank" rel="noopener noreferrer" class="nav-link text-base font-medium">Our Facebook Page</a>
                            <?php endif; ?>
                            <a href="<?php echo e(route('privacy-policy.show')); ?>" class="nav-link text-base font-medium <?php echo e(request()->routeIs('privacy-policy.show') ? 'active' : ''); ?>">Privacy Policy</a>
                            <?php if($appSettings->app_download_url): ?>
                                <a href="<?php echo e($appSettings->app_download_url); ?>" target="_blank" rel="noopener noreferrer"  class="flex flex-row  nav-link text-base font-medium">
...
<g>
			...
			<path d="M357.375,57.136c-5.726-5.82-12.894-11.998-21.623-17.715l13.244-27.153c2.074-4.233,0.316-9.344-3.925-11.409
				...
				C315.732,94.76,308.086,102.397,298.665,102.397z"/>
                     ...
                     <?php if(auth()->user()->role === 'admin'): ?>
                            <a href="<?php echo e(route('admin.categories.index')); ?>" class="nav-link text-base font-medium <?php echo e(request()->routeIs('admin.categories.index') ? 'active' : ''); ?>">Categories</a>
                            <a href="<?php echo e(route('admin.products.index')); ?>" class="nav-link text-base font-medium <?php echo e(request()->routeIs('admin.products.index') ? 'active' : ''); ?>">Products</a>
                            <a href="<?php echo e(route('admin.users.index')); ?>" class="nav-link text-base font-medium <?php echo e(request()->routeIs('admin.users.index') ? 'active' : ''); ?>">Users</a>
                            <a href="<?php echo e(route('admin.contacts.index')); ?>" class="nav-link text-base font-medium <?php echo e(request()->routeIs('admin.contacts.index') ? 'active' : ''); ?>">Contacts</a>
                            <a href="<?php echo e(route('admin.settings.edit')); ?>" class="nav-link text-base font-medium <?php echo e(request()->routeIs('admin.settings.edit') ? 'active' : ''); ?>">Settings</a>
                    <?php endif; ?>
                  <?php endif; ?>
                ...
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <form method="POST" action="<?php echo e(route('logout')); ?>" id="desktop-logout-form" class="hidden">
                        <?php echo csrf_field(); ?>
                    </form>
                    <?php if(auth()->user()->role === 'user'): ?>
                        <form method="POST" action="<?php echo e(route('account.destroy')); ?>" id="delete-account-form" class="hidden">
                            <?php echo csrf_field(); ?>
                ...
                <div class="hidden lg:relative lg:block">
                        ...
                        <!-- Dropdown Menu -->
                            ...
                            <div 
                                ...
                                <div class="border-b  border-border px-3 py-3">
                                    <h5 class="mb-2 font-semibold" ><?php echo e(auth()->user()->name); ?> </h5>
                                    <p class="text-base"><?php echo e(auth()->user()->phone); ?></p>
                                </div>
                    ...
                    <?php if($appSettings->navbar_phone): ?>
                    <a
                        href="<?php echo e($appSettings->navbarPhoneHref()); ?>"
                        class="flex font-semibold items-center text-white gap-1 no-underline hover:text-white"
                    >
                    <svg fill="currentColor" class="size-5 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path d="M224.2 89C216.3 70.1 195.7 60.1 176.1 65.4L170.6 66.9C106 84.5 50.8 147.1 66.9 223.3C104 398.3 241.7 536 416.7 573.1C493 589.3 555.5 534 573.1 469.4L574.6 463.9C580 444.2 569.9 423.6 551.1 415.8L453.8 375.3C437.3 368.4 418.2 373.2 406.8 387.1L368.2 434.3C297.9 399.4 241.3 341 208.8 269.3L253 233.3C266.9 222 271.6 202.9 264.8 186.3L224.2 89z"/></svg>
                    <?php echo e($appSettings->navbar_phone); ?>
        ...
        <div class="fixed inset-0 flex">
            ...
            >
                <?php if(auth()->guard()->check()): ?>
                    <div class="flex items-center justify-between gap-3 border-b border-slate-100 bg-secondary px-6 py-4">
                        <img 
                            ...
                            src="<?php echo e(auth()->user()->photo ? asset('storage/' . auth()->user()->photo) : asset('images/user-placeholder.png')); ?>"
                            alt="<?php echo e(auth()->user()->name); ?>"
                            width="56" 
                            height="56"
                        >
                        <div class="grow min-w-0">
                            <h5 class="truncate text-xl font-semibold text-white"><?php echo e(auth()->user()->name); ?></h5>
                            <p class="truncate font-semibold text-white/90 text-sm"><?php echo e(auth()->user()->phone); ?></p>
                        </div>
                    ...
                    <div class="grow overflow-y-auto px-6 py-4">
                        <nav class="flex flex-col gap-2.5">
                            ...
                            <?php if(auth()->user()->role === 'user'): ?>
                                <a href="<?php echo e(route('categories.all')); ?>" class="flex items-center gap-3 border-b border-slate-200 pb-2.5 hover:bg-slate-50 transition">
                                ...
                                <a href="<?php echo e(route('executives')); ?>" class="flex items-center gap-3 border-b border-slate-200 pb-2.5 hover:bg-slate-50 transition">
                                ...
                                <?php if($appSettings->facebook_page_url): ?>
                                    <a href="<?php echo e($appSettings->facebook_page_url); ?>" target="_blank" rel="noopener noreferrer" class="flex items-center gap-3 border-b border-slate-200 pb-2.5 hover:bg-slate-50 transition">
                                ...
                                <?php endif; ?>
                                <a href="<?php echo e(route('privacy-policy.show')); ?>" class="flex items-center gap-3 border-b border-slate-200 pb-2.5 hover:bg-slate-50 transition">
                                ...
                                <?php if($appSettings->app_download_url): ?>
                                    <a href="<?php echo e($appSettings->app_download_url); ?>" target="_blank" rel="noopener noreferrer" class="text-text-body flex items-center gap-3 border-b border-slate-200 pb-2.5 hover:bg-slate-50 transition">
                            ...
                            <?php if(auth()->user()->role === 'admin'): ?>
                                <a href="<?php echo e(route('admin.categories.index')); ?>" class="flex items-center gap-3 border-b border-slate-200 pb-2.5 hover:bg-slate-50 transition">
                                ...
                                <a href="<?php echo e(route('admin.products.index')); ?>" class="flex items-center gap-3 border-b border-slate-200 pb-2.5 hover:bg-slate-50 transition">
                                    <svg class="size-6 text-secondary-500" fill="currentColor" viewBox="0 0 640 640"><path d="M208.3 64L432.3 64C458.8 64 480.4 85.8 479.4 112.2C479.2 117.5 479 122.8 478.7 128L528.3 128C554.4 128 577.4 149.6 575.4 177.8C567.9 281.5 514.9 338.5 457.4 368.3C441.6 376.5 425.5 382.6 410.2 387.1C390 415.7 369 430.8 352.3 438.9L352.3 512L416.3 512C434 512 448.3 526.3 448.3 544C448.3 561.7 434 576 416.3 576L224.3 576C206.6 576 192.3 561.7 192.3 544C192.3 526.3 206.6 512 224.3 512L288.3 512L288.3 438.9C272.3 431.2 252.4 416.9 233 390.6C214.6 385.8 194.6 378.5 175.1 367.5C121 337.2 72.2 280.1 65.2 177.6C63.3 149.5 86.2 127.9 112.3 127.9L161.9 127.9C161.6 122.7 161.4 117.5 161.2 112.1C160.2 85.6 181.8 63.9 208.3 63.9zM165.5 176L113.1 176C119.3 260.7 158.2 303.1 198.3 325.6C183.9 288.3 172 239.6 165.5 176zM444 320.8C484.5 297 521.1 254.7 527.3 176L475 176C468.8 236.9 457.6 284.2 444 320.8z"/></svg>
                                    <span class="text-md font-semibold text-black">Products</span>
                                </a>
                                <a href="<?php echo e(route('admin.users.index')); ?>" class="flex items-center gap-3 border-b border-slate-200 pb-2.5 hover:bg-slate-50 transition">
                                ...
                                <a href="<?php echo e(route('admin.contacts.index')); ?>" class="flex items-center gap-3 border-b border-slate-200 pb-2.5 hover:bg-slate-50 transition">
                                ...
                                <a href="<?php echo e(route('admin.settings.edit')); ?>" class="flex items-center gap-3 border-b border-slate-200 pb-2.5 hover:bg-slate-50 transition">
                            ...
                            <a onclick="event.preventDefault(); document.getElementById('desktop-logout-form').submit();" href="<?php echo e(route('logout')); ?>" class="flex items-center gap-3 border-b border-slate-200 pb-2.5 hover:bg-slate-50 transition">
                ...
                <?php if(auth()->guard()->guest()): ?>
                    ...
                    <div class="grow overflow-y-auto px-6 py-4">
                        <nav class="flex flex-col gap-2.5">
                            ...
                            <a
                                href="<?php echo e($appSettings->navbarPhoneHref()); ?>"
                                class="flex items-center gap-3 border-b border-slate-200 pb-2.5 no-underline hover:bg-slate-50 transition"
                            >
                            <svg fill="currentColor" class="size-6 text-secondary-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path d="M224.2 89C216.3 70.1 195.7 60.1 176.1 65.4L170.6 66.9C106 84.5 50.8 147.1 66.9 223.3C104 398.3 241.7 536 416.7 573.1C493 589.3 555.5 534 573.1 469.4L574.6 463.9C580 444.2 569.9 423.6 551.1 415.8L453.8 375.3C437.3 368.4 418.2 373.2 406.8 387.1L368.2 434.3C297.9 399.4 241.3 341 208.8 269.3L253 233.3C266.9 222 271.6 202.9 264.8 186.3L224.2 89z"/></svg>
                            <span class="text-md font-semibold text-black"><?php echo e($appSettings->navbar_phone); ?></span>
                            </a>
                            <?php endif; ?>
                ...
                <div class="w-full px-6 mt-auto pt-4">
                    <img 
                        src="<?php echo e(asset('images/site-large-logo.png')); ?>"
    ...
    <?php if(auth()->guard()->check()): ?>
        ...
        <?php endif; ?>
    <?php endif; ?>
<?php /**PATH /home/tahazzat/works/projects/personal-projects/trophy-app/trophy-app-web/resources/views/partials/header.blade.php ENDPATH**/ ?>