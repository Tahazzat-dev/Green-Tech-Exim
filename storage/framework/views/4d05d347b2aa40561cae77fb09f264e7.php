...
<div class="flex items-center justify-center w-full min-h-screen h-full p-4 mx-auto">
    <div class="w-full max-w-[500px] shadow-lg bg-background rounded-2xl p-4 md:p-5 lg:py-8 xl:py-10">
        <div class="mb-8">
            <h4 class="text-base">Admin Access</h4>
            <h1 class="font-bold mt-2">Sign In to Admin Panel</h1>
            <p class="mt-3 text-sm">
                Use your admin phone number and PIN. If two-factor authentication is enabled, you will be asked for a code from your authenticator app.
            </p>
        </div>

        <form autocomplete="off" method="POST" action="<?php echo e(route('admin.signin.submit')); ?>" class="space-y-5">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <!-- <div class="space-y-2 text-center">
                <a class="inline-block underline link-text" href="<?php echo e(route('signin')); ?>">
                    User login
                </a>
            </div> -->
        </form>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/tahazzat/works/projects/personal-projects/trophy-app/trophy-app-web/resources/views/auth/admin-signin.blade.php ENDPATH**/ ?>