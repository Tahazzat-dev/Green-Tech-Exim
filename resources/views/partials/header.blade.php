                ...
                <nav class="hidden lg:flex text-base lg:gap-10">
                  @auth
                     ...
                     @if(auth()->user()->role === 'admin')
                            <a href="{{ route('signin') }}" class="nav-link text-base font-medium {{ request()->routeIs('categories') ? 'active' : '' }}">Categories</a>
                            <a href="{{ route('signin') }}" class="nav-link text-base font-medium {{ request()->routeIs('trophies') ? 'active' : '' }}">Trophies</a>
                            <a href="{{ route('signin') }}" class="nav-link text-base font-medium {{ request()->routeIs('signin') ? 'active' : '' }}">Users</a>
                            <a href="{{ route('signin') }}" class="nav-link text-base font-medium {{ request()->routeIs('signin') ? 'active' : '' }}">Contacts</a>
                    @endif
                  @endauth
                     ...
                     @if(auth()->user()->role === 'user')
                        <div class="overflow-y-auto px-6 py-4">
                            <nav class="space-y-1 flex flex-col gap-2.5">
                                <a href="{{ route('categories.all') }}" class="flex items-center gap-3 pb-2.5 border-b border-slate-300"  >
                                ...
                                <a href="{{ route('executives') }}" class="flex items-center gap-3 pb-2.5 border-b border-slate-300"  >
                                ...
                                <a href="https://wa.me/?text={{ urlencode(config('app.url')) }}" target="_blank" class="flex items-center gap-3 pb-2.5 border-b border-slate-300"  >
